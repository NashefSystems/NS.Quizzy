...
namespace NS.Quizzy.Server.DAL.Migrations
{
    ...
    [Migration("20241207141940_fixing classes names")]
    partial class fixingclassesnames
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("NS.Quizzy.Server.DAL.Entities.Class", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedTime = new DateTimeOffset(new DateTime(2024, 12, 7, 16, 19, 40, 19, DateTimeKind.Unspecified).AddTicks(8882), new TimeSpan(0, 2, 0, 0, 0)),
                            IsDeleted = false,
                            ModifiedTime = new DateTimeOffset(new DateTime(2024, 12, 7, 16, 19, 40, 19, DateTimeKind.Unspecified).AddTicks(8882), new TimeSpan(0, 2, 0, 0, 0)),
                            Name = "שכבה י'"
                        },
                        new
                        {
