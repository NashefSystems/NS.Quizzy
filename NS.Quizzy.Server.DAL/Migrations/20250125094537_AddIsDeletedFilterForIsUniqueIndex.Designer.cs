...
namespace NS.Quizzy.Server.DAL.Migrations
{
    ...
    [Migration("20250125094537_AddIsDeletedFilterForIsUniqueIndex")]
    partial class AddIsDeletedFilterForIsUniqueIndex
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("NS.Quizzy.Server.DAL.Entities.AppSetting", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedTime = new DateTimeOffset(new DateTime(2025, 1, 25, 11, 45, 36, 639, DateTimeKind.Unspecified).AddTicks(6109), new TimeSpan(0, 2, 0, 0, 0)),
                            IsDeleted = false,
                            IsSecured = false,
                            Key = "SavePasswordOnRememberMe",
                            ModifiedTime = new DateTimeOffset(new DateTime(2025, 1, 25, 11, 45, 36, 639, DateTimeKind.Unspecified).AddTicks(6109), new TimeSpan(0, 2, 0, 0, 0)),
                            Target = "Client",
                            Value = "true",
                            ValueType = "Boolean"
                        });
