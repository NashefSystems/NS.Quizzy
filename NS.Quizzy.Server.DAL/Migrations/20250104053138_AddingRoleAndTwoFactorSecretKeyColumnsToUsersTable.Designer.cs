...
namespace NS.Quizzy.Server.DAL.Migrations
{
    ...
    [Migration("20250104053138_AddingRoleAndTwoFactorSecretKeyColumnsToUsersTable")]
    partial class AddingRoleAndTwoFactorSecretKeyColumnsToUsersTable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("NS.Quizzy.Server.DAL.Entities.AppSetting", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedTime = new DateTimeOffset(new DateTime(2025, 1, 4, 7, 31, 38, 143, DateTimeKind.Unspecified).AddTicks(3179), new TimeSpan(0, 2, 0, 0, 0)),
                            IsDeleted = false,
                            IsSecured = false,
                            Key = "SavePasswordOnRememberMe",
                            ModifiedTime = new DateTimeOffset(new DateTime(2025, 1, 4, 7, 31, 38, 143, DateTimeKind.Unspecified).AddTicks(3179), new TimeSpan(0, 2, 0, 0, 0)),
                            Target = "Client",
                            Value = "true",
                            ValueType = "Boolean"
                        });
