...
namespace NS.Quizzy.Server.DAL.Migrations
{
    ...
    [Migration("20241228062113_Adding AppSettings table")]
    partial class AddingAppSettingstable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("NS.Quizzy.Server.DAL.Entities.AppSetting", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedTime = new DateTimeOffset(new DateTime(2024, 12, 28, 8, 21, 12, 454, DateTimeKind.Unspecified).AddTicks(760), new TimeSpan(0, 2, 0, 0, 0)),
                            IsDeleted = false,
                            IsSecured = false,
                            Key = "SavePasswordOnRememberMe",
                            ModifiedTime = new DateTimeOffset(new DateTime(2024, 12, 28, 8, 21, 12, 454, DateTimeKind.Unspecified).AddTicks(760), new TimeSpan(0, 2, 0, 0, 0)),
                            Target = "Client",
                            Value = "true",
                            ValueType = "Boolean"
                        });
