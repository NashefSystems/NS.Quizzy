...
namespace NS.Quizzy.Server.DAL.Migrations
{
    ...
    [Migration("20241123152558_Initialization DataBase")]
            ...
            modelBuilder.Entity("NS.Quizzy.Server.DAL.Entities.Class", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedTime = new DateTimeOffset(new DateTime(2024, 11, 23, 17, 25, 58, 482, DateTimeKind.Unspecified).AddTicks(9408), new TimeSpan(0, 2, 0, 0, 0)),
                            IsDeleted = true,
                            ModifiedTime = new DateTimeOffset(new DateTime(2024, 11, 23, 17, 25, 58, 482, DateTimeKind.Unspecified).AddTicks(9408), new TimeSpan(0, 2, 0, 0, 0)),
                            Name = "10"
                        },
                        new
                        {
