...
namespace NS.Quizzy.Server.DAL.Migrations
{
    ...
    [Migration("20241130164624_Undelete items")]
    partial class Undeleteitems
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("NS.Quizzy.Server.DAL.Entities.Class", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedTime = new DateTimeOffset(new DateTime(2024, 11, 30, 18, 46, 23, 699, DateTimeKind.Unspecified).AddTicks(6775), new TimeSpan(0, 2, 0, 0, 0)),
                            IsDeleted = false,
                            ModifiedTime = new DateTimeOffset(new DateTime(2024, 11, 30, 18, 46, 23, 699, DateTimeKind.Unspecified).AddTicks(6775), new TimeSpan(0, 2, 0, 0, 0)),
                            Name = "10"
                        },
                        new
                        {
